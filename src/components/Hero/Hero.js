...
const Hero = () => {
  return (
    <div id='home' className='min-h-screen py-20 mt-20' style={{backgroundImage: `url(${fetchedImgSrc})`, backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPosition:'center center' }}>
